          ...
          <div class="flex justify-start items-center">
              {
                socialMedia === 'tw' ? (
                  ...
                  <div className='flex'>
                        ...
                        <span class="self-center text-xl font-semibold whitespace-nowrap text-gray-800">Account Recommendations</span> 
                    </div>
                ) : socialMedia ==='alerts' ? (
                  <div className='flex'>
                        ...
                        <span class="self-center text-xl font-semibold whitespace-nowrap text-gray-800">Account Alerts</span> 
                    </div>
                )
                : (
                    <div className='flex'>
