  ...
  <div class="fixed flex flex-col top-0 left-0 w-[14rem] bg-white h-full border-r">
    ...
    <div class="overflow-y-auto overflow-x-hidden flex-grow">
      <ul class="flex flex-col py-4 space-y-1">
        ...
        <li>
          <a href="/?=alerts" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-[#FC8E02] pr-6">
            <span class="inline-flex justify-center items-center ml-4">
        ...
        <li>
          <a href="/?=rec" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-[#FC8E02] pr-6">
            <span class="inline-flex justify-center items-center ml-4">
