...
<div className="h-[100vh] bg-[#E4EAEE] w-full py-2 px-4">
            ...
            <div className="flex flex-col items-center justify-center scale-90">
                ...
                <div className="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-32">
                    ...
                    <p  className="focus:outline-none text-sm mt-4 font-medium leading-none text-gray-500">Already have account? <a href="/login"   className="hover:text-[#F9AA00] focus:text-gray-500 focus:outline-none focus:underline hover:underline text-sm font-bold leading-none  text-[#E37401] cursor-pointer"> Login here</a></p>
                    <div className='mt-6'> 
                        ...
                        <div className="mt-8">
                            <button role="button" className="focus:ring-2 focus:ring-offset-2 focus:ring-[#E37401] text-md font-semibold leading-none text-white focus:outline-none bg-[#E37401] border rounded hover:bg-[#E37401] hover:translate-y-[-2px] transition-all duration-200 py-4 w-full">Create my account</button>
                        </div>
                </div>
            </div>
        </div>
